defmodule AmnesiacWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AmnesiacWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AmnesiacWeb.Gettext, "errors", msg, opts)
    end
  end
